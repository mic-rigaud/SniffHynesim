...
attacks. To do that effectively cyber engineer need to analyze cyber attack to find the way to detect them. A
...
IDS and the most popular IDS. And to finish we will present the aim of this project and the organization of the project.
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%
...
virtualize and simulate network. By this way, we could test under many attack our solution to secure network.
